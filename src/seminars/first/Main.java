...
import seminars.first.hw.Product;
import seminars.first.hw.Shop;
import seminars.first.hw.ShopTest;
...
//    }
    ...
    public static void discount() {
        ...
        assertThatThrownBy(()->
                Calculator.calculatingDiscount(-1,5))
        ...
        assertThatThrownBy(()->
                ...
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Процент скидки может быть только от 0 до 100");
    ...
    public static void shopTest(){
        ...
        Product apple = new Product(150, "Яблоко");
        Product carrot = new Product(75, "Морковь");
        Product tomato = new Product(200, "Помидор");
        Product potato = new Product(100, "Картофель");
        ...
        ShopTest.testList(productList);


        System.out.println(productList.getSortedListProducts());
        System.out.println("Самый дорой продукт: " + productList.getMostExpensiveProduct());

        ShopTest.testGetMostExpensiveProduct(productList);
        ShopTest.testGetSortedListProducts(productList);
